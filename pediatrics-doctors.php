...
<body>
    ...
    <main class="page-container">
        <div class="service-detail">
            ...
            <p>Our Pediatrics department provides a warm, child-friendly environment dedicated to the unique health
                needs of your family, from infancy through adolescence.</p>
        ...
        <div class="doctor-list">
            <div class="doctor-card">
                ...
                <div class="doctor-info">
                    ...
                    <p>Prof. Shaman Rajindrajith is a trusted expert in general pediatrics...</p>
            ...
            <div class="doctor-card">
                ...
                <div class="doctor-info">
                    ...
                    <p>Dr. Duminda leads our Neonatal Intensive Care Unit (NICU)...</p>
                    <a href="#" class="button">Book Appointment</a>
                </div>
            </div>
        </div>
